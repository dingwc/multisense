...
if __name__ == "__main__":
    ...
    for disttype in ['cossim','dotsim']:
        ...
        aname = 'embeddings/embeddings_chen_%s_%s_%s_%s.txt' % (vocabtype,testclass,testtype,tail)
        compute_question2embed(qname, aname, vocab2id, vectorlist,disttype)
        ...
        aname = 'embeddings/embeddings_chen_%s_%s_%s_%s_%s.txt' % (vocabtype,testclass,princeton_tail,testtype,tail)
        compute_question2embed(qname, aname, vocab2id, vectorlist,disttype)
        ...
        aname = 'embeddings/embeddings_chen_scws_%s_%s.txt' % (vocabtype,tail)  
        compute_question2embed(qname, aname, vocab2id,  vectorlist,disttype)
        
        
        qname = '../tests/koeling_%s_questions.txt' % vocabtype
        aname = 'embeddings/embeddings_chen_koeling_%s_%s.txt' % (vocabtype,tail)  
        compute_question2embed(qname, aname, vocab2id,  vectorlist,disttype)
        
        qname = '../tests/wsd_%s_questions.txt' % vocabtype
        aname = 'embeddings/embeddings_chen_wsd_%s_%s.txt' % (vocabtype,tail)  
        compute_question2embed(qname, aname, vocab2id,  vectorlist,disttype)
